...
start=time.time()
AminoAcidName='TYR' # We can change amino acid
...
def Find_key_info_all_aa(aa_list_,*args): #Finds different parameters for each aa (i.e Total_keys,Distinct_keys etc)
    Distict_key_set_ = []
    All_key_dict_ = []
